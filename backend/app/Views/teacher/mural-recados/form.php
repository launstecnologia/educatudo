...
<div class="mb-8">
    <div class="flex justify-between items-center">
        ...
        <a href="<?= URL ?>/professor/mural-recados" class="text-gray-600 hover:text-gray-900">← Voltar</a>
    </div>
</div>

<form action="<?= $isEdit ? URL . '/professor/mural-recados/atualizar' : URL . '/professor/mural-recados/salvar' ?>" method="post" class="space-y-6 bg-white rounded-xl shadow-lg p-6">
    ...
    <div class="flex gap-3">
        <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700"><?= $isEdit ? 'Atualizar' : 'Publicar' ?></button>
        <a href="<?= URL ?>/professor/mural-recados" class="bg-gray-200 text-gray-800 px-6 py-2 rounded-lg hover:bg-gray-300">Cancelar</a>
    </div>
</form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggle() {
        container.classList.toggle('hidden', rTodos && rTodos.checked);
    }
