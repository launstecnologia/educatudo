<?php
/**
 * View: Professor - Lista de Notificações
 */
...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?= URL ?>/professor/notifications/create" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center">
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <?php if (empty($notificacoes)): ?>
            ...
            <svg class="w-16 h-16 mx-auto text-gray-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-gray-500">Comece criando sua primeira notificação para sua turma.</p>
            </div>
        <?php else: ?>
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500"><?= htmlspecialchars(substr($notificacao['conteudo'], 0, 50)) ?>...</div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        <a href="<?= URL ?>/professor/notifications/<?= $notificacao['id'] ?>" class="text-blue-600 hover:text-blue-900">Ver</a>
                                        <a href="<?= URL ?>/professor/notifications/<?= $notificacao['id'] ?>/delete" 
