...
<div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-xl shadow border border-gray-200 p-6 flex flex-col">
            ...
            <p class="text-2xl font-bold text-primary-600 mt-2">R$ <?= $valorReais ?></p>
            ...
            <form method="post" action="<?= URL ?>/professor/carteira/comprar" class="mt-4">
                ...
                <button type="submit" class="w-full px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 text-sm font-medium">Comprar</button>
            </form>
        </div>
        <?php endforeach; ?>
    </div>
