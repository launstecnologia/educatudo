<?php
$reports_filter_form_action = URL . '/professor/jornadas/relatorio';
$reports_filter_clear_url = URL . '/professor/jornadas/relatorio';
$reports_filter_base_url = URL . '/professor/jornadas/relatorio';
$reports_filter_hide_professor = true;
?>
<div class="mb-8">
    <div class="flex flex-wrap justify-between items-start gap-4">
        <div>
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Relatório de Jornadas</h2>
            <p class="text-gray-600">Acompanhamento das suas jornadas por aluno (conclusão, pendências e tempo).</p>
        </div>
...
<div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
    <div class="p-6">
        <?php require __DIR__ . '/../admin/reports/_tab_jornadas.php'; ?>
    </div>
</div>
