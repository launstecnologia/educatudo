...
<div class="mb-8">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-2">Gerenciar jornadas de aprendizado e acompanhar o progresso dos alunos</p>
        </div>
...
<div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
    <div class="flex items-center">
        ...
        <div>
            <h3 class="text-sm font-medium text-blue-800">Gerenciamento de Jornadas</h3>
            <p class="text-sm text-blue-700">Visualizar e gerenciar jornadas de aprendizado para seus alunos. Acompanhar progresso e desempenho.</p>
        </div>
    </div>
</div>
    ...
    <?php if (empty($jornadas)): ?>
        <div class="col-span-full">
            <div class="bg-white rounded-xl shadow-lg p-12 text-center">
                ...
                <a href="<?= URL ?>/professor/jornadas/criar" class="inline-flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow jornada-card" 
                ...
                <div class="flex items-start justify-between mb-4">
                    <div class="flex-1">
                        ...
                        <p class="text-gray-600 text-sm"><?= htmlspecialchars($jornada['descricao'] ?: 'Nenhuma descrição disponível') ?></p>
                    </div>
                    <div class="flex items-center space-x-2">
                        <?php
                        $status = $jornada['status_jornada'] ?? 'em_andamento';
                        $statusLabels = [
                        ...
                        $statusInfo = $statusLabels[$status] ?? $statusLabels['em_andamento'];
                        ?>
                        <span class="px-2 py-1 <?= $statusInfo['class'] ?> text-xs rounded-full font-semibold">
                            <?= $statusInfo['label'] ?>
                        </span>
                    </div>
                </div>
                ...
                <div class="space-y-2 mb-4">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <span class="font-medium text-gray-900">
                            <?= date('d/m/Y', strtotime($jornada['data_inicio'])) ?> - <?= date('d/m/Y', strtotime($jornada['data_fim'])) ?>
                        </span>
                    </div>
                    <?php endif; ?>
                    <div class="flex items-center justify-between text-sm">
