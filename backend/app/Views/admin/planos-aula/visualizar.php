...
<div class="bg-white rounded-xl shadow-lg p-6 mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <p class="text-lg font-medium text-gray-900"><?= htmlspecialchars($plano['professor_nome'] ?? 'N/A') ?></p>
        </div>
        <div>
...
<div class="bg-white rounded-xl shadow-lg p-6 mb-6">
    ...
    <div class="mb-4">
        <p class="text-sm text-gray-500 mb-2">Objetivos Gerais</p>
        <div class="bg-gray-50 rounded-lg p-4">
...
<!-- Metodologia -->
<div class="bg-white rounded-xl shadow-lg p-6 mb-6">
    <h2 class="text-xl font-semibold text-gray-900 mb-4 border-b pb-2">Metodologia</h2>
    <?php if (!empty($plano['metodologia'])): ?>
    <div class="mb-4">
        <p class="text-sm text-gray-500 mb-2">Metodologia</p>
        <div class="bg-gray-50 rounded-lg p-4">
            <p class="text-gray-800 whitespace-pre-wrap"><?= htmlspecialchars($plano['metodologia']) ?></p>
        </div>
    </div>
    <?php endif; ?>
...
<div class="bg-white rounded-xl shadow-lg p-6 mb-6">
    ...
    <div class="mb-4">
        <p class="text-sm text-gray-500 mb-2">Recursos Utilizados</p>
        <div class="bg-gray-50 rounded-lg p-4">
