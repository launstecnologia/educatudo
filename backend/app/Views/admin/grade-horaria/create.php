<?php
$title = $title ?? 'Nova Aula na Grade - EducaTudo';
$user = $user ?? null;
...
<div class="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50">
    <div class="bg-white/80 backdrop-blur-sm border-b border-purple-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Nova Aula na Grade</h1>
                    <p class="mt-2 text-gray-600">Dia da semana, horário, turma, professor, matéria e período (Manhã/Tarde)</p>
                </div>
                <div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200">
            ...
            <form action="<?= URL ?>/admin/grade-horaria" method="post" class="p-6 space-y-5">
