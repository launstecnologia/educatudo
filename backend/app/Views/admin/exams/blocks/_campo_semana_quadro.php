...
<div class="mb-6" id="campo-semana-evento">
    <?php if ($temGruposRegras): ?>
        ...
        <p class="text-xs text-gray-500 mt-1">Uma avaliação pode alimentar vários quadros (ex.: S1 do quadro semanal e AV1 de outro). Cadastre em Acadêmico → Quadro de Notas.</p>
        <script>
        (function () {
            ...
            function addLinha(data) {
                ...
                wrap.querySelector('.sel-tipo').addEventListener('change', function () { syncLinha(wrap); });
    ...
    <?php else: ?>
        ...
        <p class="text-xs text-gray-500 mt-1">Para prova semanal, escolha a semana (S1, S2…). Cadastre um Quadro de Notas para separar blocos de disciplinas (A/B, Humanas…).</p>
    <?php endif; ?>
</div>
<script>
(function () {
