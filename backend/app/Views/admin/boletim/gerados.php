...
<div class="space-y-6">
    <div class="flex items-center justify-between gap-3 flex-wrap">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Inspecione tudo que está salvo em <code class="bg-gray-100 px-1 rounded">boletim_resultados_gerados</code>. Use o preview para conferir e o botão Remover para apagar registros antigos.</p>
        </div>
                        ...
                        <?php foreach ($rows as $idx => $row): ?>
                            ...
                            <tr class="boletim-gerado-row <?= $idx % 2 === 0 ? 'bg-white' : 'bg-gray-50' ?>"
                                ...
                                <td class="px-3 py-2">
                                    ...
                                    <?php else: ?>
                                        <span class="inline-block px-2 py-0.5 text-xs rounded-full bg-emerald-100 text-emerald-800">oficial</span>
                                    <?php endif; ?>
                                    <?php if ($exibirEmRow !== ''): ?>
