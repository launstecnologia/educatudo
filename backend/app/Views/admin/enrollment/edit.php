    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <select name="ano_letivo_id" class="w-full border border-gray-300 rounded-xl px-3 py-2.5 text-sm">
                    <option value="">—</option>
            ...
            <div>
                ...
                <select name="turma_id" class="w-full border border-gray-300 rounded-xl px-3 py-2.5 text-sm">
                    <option value="">—</option>
