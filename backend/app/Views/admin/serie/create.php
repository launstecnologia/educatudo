...
$page_header_title = 'Cadastrar Série';
$page_header_subtitle = 'Informe o curso e o nome da série para vincular às turmas.';
include __DIR__ . '/../_partials/page_header_form.php';
?>

<div class="bg-white rounded-lg shadow-sm border border-gray-200 w-full">
    <form method="POST" action="<?= URL ?>/admin/serie" class="divide-y divide-gray-200">
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="nome" name="nome" required placeholder="Ex.: 1º Ano, 2º Ano"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500">
                </div>
                <div>
        ...
        $form_submit_label = 'Cadastrar Série';
