...
$showPedagogicoGroup = $modOn('aulas_online')
    ...
    || ($canViewSidebar(['inclusao']) && $modOn('inclusao'))
...
<div class="menu-group">
    ...
    <div id="academico-submenu" class="<?= $academicoOpen ? '' : 'hidden' ?> ml-4 mt-1 space-y-1 border-l-2 border-white/20 pl-2">
        ...
        <a href="<?= URL ?>/admin/implantar-academico" class="<?= $linkCls($cp === 'implantar-academico') ?>">
        ...
        <a href="<?= URL ?>/admin/cursos-series" class="<?= $linkCls(in_array($cp, ['curso', 'serie', 'cursos-series'], true)) ?>">
        ...
        <a href="<?= URL ?>/admin/provas/tipos-avaliacao" class="<?= $linkCls($cp === 'tipos_avaliacao') ?>">
        ...
        <a href="<?= URL ?>/admin/quadros-notas" class="<?= $linkCls(in_array($cp, ['grupos-regras-notas', 'quadros-notas'], true)) ?>">
...
<!-- Rotina -->
<?php if (!empty($showRotinaGroup)): ?>
<div class="menu-group">
    <div class="flex items-center rounded-xl <?= $cp === 'rotina' ? 'bg-white/20' : '' ?>">
        <a href="<?= URL ?>/admin/rotina" class="flex-1 flex items-center px-4 py-3 text-purple-100 hover:bg-white/20 hover:text-white rounded-xl transition-all duration-200">
            <i class="fa-regular fa-clipboard w-5 h-5 mr-3"></i>
            <span class="sidebar-text">Rotina</span>
        </a>
        <button type="button" onclick="toggleMenuGroup('rotina')" class="px-3 py-3 text-purple-100 hover:text-white transition-colors" title="Expandir submenu">
            <svg id="rotina-arrow" class="w-4 h-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
        </button>
    </div>
    <div id="rotina-submenu" class="<?= !empty($rotinaOpen) ? '' : 'hidden' ?> ml-4 mt-1 space-y-1 border-l-2 border-white/20 pl-2">
        ...
        <?php endif; ?>
        <?php if ($modOn('faltas') || ($canViewSidebar(['presenca']) && $modOn('presenca'))): ?>
        <a href="<?= URL ?>/admin/frequencia" class="<?= $linkCls(in_array($cp, ['frequencia', 'faltas', 'presenca'], true)) ?>">
...
<!-- Fechamento -->
<?php if (!empty($showFechamentoGroup)): ?>
<div class="menu-group">
    <div class="flex items-center rounded-xl <?= !empty($fechamentoOpen) ? 'bg-white/20' : '' ?>">
        <a href="<?= URL ?>/admin/<?= ($canViewSidebar(['resultados_finais']) && $modOn('resultados_finais')) ? 'fechamento' : 'conselhos' ?>" class="flex-1 flex items-center px-4 py-3 text-purple-100 hover:bg-white/20 hover:text-white rounded-xl transition-all duration-200">
            <i class="fa-solid fa-clipboard-check w-5 h-5 mr-3"></i>
            <span class="sidebar-text">Fechamento</span>
        </a>
        <button type="button" onclick="toggleMenuGroup('fechamento')" class="px-3 py-3 text-purple-100 hover:text-white transition-colors" title="Expandir submenu">
            <svg id="fechamento-arrow" class="w-4 h-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
        </button>
    </div>
    <div id="fechamento-submenu" class="<?= !empty($fechamentoOpen) ? '' : 'hidden' ?> ml-4 mt-1 space-y-1 border-l-2 border-white/20 pl-2">
...
<!-- Secretaria -->
<div class="menu-group">
    <div class="flex items-center rounded-xl <?= in_array($cp, ['gestao_escolar', 'secretaria'], true) ? 'bg-white/20' : '' ?>">
        <a href="<?= URL ?>/admin/gestao-escolar" class="flex-1 flex items-center px-4 py-3 text-purple-100 hover:bg-white/20 hover:text-white rounded-xl transition-all duration-200">
            <i class="fa-regular fa-folder-open w-5 h-5 mr-3"></i>
            <span class="sidebar-text">Secretaria</span>
        </a>
        <button type="button" onclick="toggleMenuGroup('secretaria')" class="px-3 py-3 text-purple-100 hover:text-white transition-colors" title="Expandir submenu">
            <svg id="secretaria-arrow" class="w-4 h-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
        </button>
    </div>
    <div id="secretaria-submenu" class="<?= !empty($secretariaNavOpen) ? '' : 'hidden' ?> ml-4 mt-1 space-y-1 border-l-2 border-white/20 pl-2">
        ...
        <?php endif; ?>
        <?php if ($canViewSidebar(['vida_escolar']) && $modOn('vida_escolar')): ?>
        <a href="<?= URL ?>/admin/vida-escolar" class="<?= $linkCls(in_array($cp, ['vida_escolar', 'vida_escolar_oficios'], true)) ?>">
...
<!-- Painéis -->
<?php if (!empty($showPaineisGroup) || $showDashboardMenu || $modOn('saude_academica')): ?>
<div class="menu-group">
    <div class="flex items-center rounded-xl <?= $cp === 'paineis' ? 'bg-white/20' : '' ?>">
        <a href="<?= URL ?>/admin/paineis" class="flex-1 flex items-center px-4 py-3 text-purple-100 hover:bg-white/20 hover:text-white rounded-xl transition-all duration-200">
            <i class="fa-solid fa-chart-pie w-5 h-5 mr-3"></i>
            <span class="sidebar-text">Painéis</span>
        </a>
        <button type="button" onclick="toggleMenuGroup('paineis')" class="px-3 py-3 text-purple-100 hover:text-white transition-colors" title="Expandir submenu">
            <svg id="paineis-arrow" class="w-4 h-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
            </svg>
        </button>
    </div>
    <div id="paineis-submenu" class="<?= !empty($paineisOpen) ? '' : 'hidden' ?> ml-4 mt-1 space-y-1 border-l-2 border-white/20 pl-2">
        <?php if ($showDashboardMenu): ?>
        <a href="<?= URL ?>/admin/dashboard" class="<?= $linkCls($cp === 'dashboard') ?>">
...
<div class="menu-group">
    ...
    <div id="pedagogico-submenu" class="<?= $pedagogicoOpen ? '' : 'hidden' ?> ml-4 mt-1 space-y-1 border-l-2 border-white/20 pl-2">
        ...
        <a href="<?= URL ?>/admin/inclusao/versoes" class="<?= $linkCls($cp === 'inclusao') ?>">
            <i class="fa-solid fa-universal-access w-4 h-4 mr-3 flex-shrink-0"></i>
