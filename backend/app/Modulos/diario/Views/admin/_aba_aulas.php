                    ...
                    ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <?php if ($aulaId > 0): ?>
                                    <a href="<?= URL ?>/admin/diario/aula?id=<?= $aulaId ?>&fechamento_id=<?= $fechamentoId ?>" class="text-xs font-semibold text-purple-700 hover:underline">Ver</a>
                                <?php else: ?>
