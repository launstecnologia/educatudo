...
<div class="bg-white rounded-xl shadow-lg p-6">
    <div class="flex justify-between items-start gap-3 flex-wrap mb-4">
        <div>
            <h3 class="text-lg font-semibold text-gray-900">Declarações já emitidas</h3>
            <p class="text-sm text-gray-500">Numeração registrada na secretaria.</p>
        </div>
        <a href="<?= URL ?>/admin/vida-escolar/oficios?aluno_id=<?= $alunoId ?>" class="px-4 py-2 rounded-lg border border-gray-300 bg-white text-sm font-medium hover:bg-gray-50">Ofícios deste aluno</a>
    </div>
    <?php if ($emissoes === []): ?>
