...
$router->get('/master/mensalidade', 'Master/MasterMensalidadeController@index');
...
$router->get('/master/escolas/{id}/provas-ao-vivo/pdf', 'Master/MasterEscolaDetailController@provasAoVivoPdf');
